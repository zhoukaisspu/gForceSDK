...
/**
    ...
    Generally Accept() is called on the TiOYMXMLDocument, although all nodes support visiting.
...
public:
    ...
    /// Visit a document.
    virtual bool VisitEnter( const OYMXMLDocument& /*doc*/ )            { return true; }
    /// Visit a document.
    virtual bool VisitExit( const OYMXMLDocument& /*doc*/ )            { return true; }
...
/** XMLNode is a base class for every object that is in the
    ...
    be navigated. A node is always in a OYMXMLDocument.
    The type of a XMLNode can be queried, and it can
    be cast to its more defined type.

    A OYMXMLDocument allocates memory for all its Nodes.
    When the OYMXMLDocument gets deleted, all its Nodes
...
class XMLNode
{
    friend class OYMXMLDocument;
    friend class XMLElement;
public:

    /// Get the OYMXMLDocument that owns this XMLNode.
    const OYMXMLDocument* GetDocument() const    { return document; }
    /// Get the OYMXMLDocument that owns this XMLNode.
    OYMXMLDocument* GetDocument()                { return document; }
    ...
    virtual OYMXMLDocument*    ToDocument()    { return 0; }    ///< Safely cast to a Document, or null.
    ...
    virtual const OYMXMLDocument*        ToDocument() const        { return 0; }
    ...
    */
    ...
    /**
        ...
        Note: if called on a OYMXMLDocument, this will return null.
    */
    virtual XMLNode* ShallowClone( OYMXMLDocument* document ) const = 0;

    /**
        Test if 2 nodes are the same, but don't test children.
        The 2 nodes do not need to be in the same Document.

        Note: if called on a OYMXMLDocument, this will return false.
    */
...
protected:
    XMLNode( OYMXMLDocument* );
    virtual ~XMLNode();
    XMLNode( const XMLNode& );    // not supported
    XMLNode& operator=( const XMLNode& );    // not supported

    OYMXMLDocument*    document;
    XMLNode*        parent;
...
public:
    ...
    virtual XMLNode* ShallowClone( OYMXMLDocument* document ) const;
    virtual bool ShallowEqual( const XMLNode* compare ) const;


protected:
    XMLText( OYMXMLDocument* doc )    : XMLNode( doc ), isCData( false )    {}
    virtual ~XMLText()                                                {}
...
protected:
    XMLDeclaration( OYMXMLDocument* doc );
...
*/
class OYMXMLDocument : public XMLNode
{
    friend class XMLElement;
public:
    /// constructor
    OYMXMLDocument( bool processEntities = true );
    ~OYMXMLDocument();

    virtual OYMXMLDocument* ToDocument()                { return this; }
    virtual const OYMXMLDocument* ToDocument() const    { return this; }
    ...
    */
    ...
    virtual XMLNode* ShallowClone( OYMXMLDocument* /*document*/ ) const    { return 0; }
    virtual bool ShallowEqual( const XMLNode* /*compare*/ ) const    { return false; }

private:
    OYMXMLDocument( const OYMXMLDocument& );    // not supported
    void operator=( const OYMXMLDocument& );    // not supported
    void InitDocument();
...
/**
    ...
    options than the OYMXMLDocument::Print() method.

    It can:
    -# Print to memory.
    -# Print to a file you provide.
    -# Print XML without a OYMXMLDocument.
    ...
    Print without a OYMXMLDocument
...
public:
    ...
    */
    ...
    virtual bool VisitEnter( const OYMXMLDocument& /*doc*/ );
    virtual bool VisitExit( const OYMXMLDocument& /*doc*/ )            { return true; }
